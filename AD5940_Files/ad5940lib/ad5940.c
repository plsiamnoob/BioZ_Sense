...
AD5940Err AD5940_HSRtiaCal(HSRTIACal_Type *pCalCfg, void *pResult)
{
  ...
  *******************************/
  ...
  uint32_t const HSTIADERLOADTable[]={0,10,30,50,100,0xFFFFFFFF};
  uint32_t const HSTIADERTIATable[] = {50,100,200,1000,5000,10000,20000,40000,80000,160000,0,0xFFFFFFFF};
  uint32_t WgAmpWord;
